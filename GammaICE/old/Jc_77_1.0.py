...
"""
19/03/2024
copied from Pulsed_IV 2.4, making a program for Jc curves measured in LN2

07/03/2024
First full trial run, found multiple bugs, working through fixing them.



Program to perform pulsed IV experiment and log data interactively
Initial Creation by Joshua Winger 14/12/2023
15/02/2024
need to add live voltage vs current plot
add timestamp to data log
re-arrange gui for better

Default port for this is port 8082, but can be changed below
2.0 changes (Joshua Winger) include:
debug mode enabled
enhancements to the visuals
Simulation and Real Data modes set up
Full Instrument connectivity in Real Data mode established
Added a hard-stop in case the stop didn't work right
"""
port = 8082
debug = False
